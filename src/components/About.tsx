...
const About: React.FC<Props> = ({ gsap, scrollTrigger, ...rest }) => {
    ...
    const photos = [
        { src: 'images/about3.png', alt: 'About 3', className: 'about-photo1', ref: $photo1 },
        { src: 'images/about2.png', alt: 'About 2', className: 'about-photo2', ref: $photo2 },
        { src: 'images/about1.png', alt: 'About 1', className: 'about-photo3', ref: $photo3 }
    ];
    ...
    const changePhoto = () => {
        ...
        const straightenPhoto = (photo: HTMLImageElement | null, right?: boolean) =>
            gsap.to(photo, {
                rotation: right ? '15' : '-7',
                scale: 1.1,
                paused: true,
        ...
        if (topPhoto === $photo1.current) {
            ...
            straightenPhoto($photo1.current, true).play();
        }
    };
